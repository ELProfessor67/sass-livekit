...
class RAGAssistant(Agent):
    ...
    @function_tool(name="start_data_collection")
    ...
    @function_tool(name="collect_name")
    ...
    @function_tool(name="collect_email")
    ...
    @function_tool(name="collect_phone")
    ...
    @function_tool(name="skip_data_collection")
    ...
    async def collect_analysis_data(self, ctx: RunContext, field_name: str, field_value: str, field_type: str = "string") -> str:
        ...
        # Return empty string to allow natural conversation flow
        # The agent should continue the conversation naturally after collecting data
        return ""
