...
export const GoHighLevelIcon = ({ size = 24, className }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" className={className}>
        <path d="M32 4C16.536 4 4 16.536 4 32s12.536 28 28 28 28-12.536 28-28S47.464 4 32 4zm0 4.8C45.82 8.8 57.2 20.18 57.2 32c0 11.82-9.38 21.44-21.12 21.96V38.4H44V28H28v10.4h-4.08C22.84 35.88 22 34.02 22 32c0-5.52 4.48-10 10-10 3.06 0 5.8 1.38 7.66 3.54l3.4-3.4A15.94 15.94 0 0 0 32 16.8c-8.4 0-15.2 6.8-15.2 15.2 0 3.64 1.28 6.98 3.4 9.58L18.5 43.2A27.1 27.1 0 0 1 8.8 32C8.8 20.18 20.18 8.8 32 8.8z" fill="#FF6B35"/>
    </svg>
);

export const HubSpotIcon = ({ size = 24, className }: IconProps) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
        {/* Official HubSpot sprocket icon */}
        <path d="M18.164 7.931V5.694a2.04 2.04 0 0 0 .813-1.634 2.043 2.043 0 0 0-4.085 0c0 .664.32 1.254.813 1.634v2.237a5.816 5.816 0 0 0-2.772 1.215L7.295 5.73a2.37 2.37 0 1 0-1.066 1.49l5.61 3.37a5.78 5.78 0 0 0-.78 2.9 5.8 5.8 0 0 0 .78 2.902l-1.73 1.205a2.305 2.305 0 1 0 .944 1.695 2.28 2.28 0 0 0-.062-.51l1.71-1.19a5.816 5.816 0 0 0 4.37 1.99 5.826 5.826 0 0 0 5.826-5.826 5.826 5.826 0 0 0-4.733-5.725Zm-5.332 8.597a3.41 3.41 0 1 1 0-6.82 3.41 3.41 0 0 1 0 6.82Z" fill="#FF7A59"/>
    </svg>
);
