...
const glassCardVariants = cva(
  "rounded-2xl border border-[#d8d9e8]/30 dark:border-white/20 bg-[#d8d9e8]/10 dark:bg-white/10 backdrop-blur-md text-[#f2f7fb] shadow-xl transition-all duration-300",
  {
    variants: {
      variant: {
        default: "",
