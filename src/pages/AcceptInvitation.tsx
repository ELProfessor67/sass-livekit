...
export function AcceptInvitation() {
    ...
    const fetchInvitationDetails = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:4000/api/v1'}/workspaces/invitation-details/${token}`);
    ...
    const handleAccept = async () => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:4000/api/v1'}/workspaces/accept-invitation`, {
                method: "POST",
                headers: {
